		...
		<!-- Header -->
			<div id="header">
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="#logout" id="logout-link" class="skel-layers-ignoreHref"><span class="icon fa-envelope">Logout</span></a></li>
							</ul>
						</nav>
				...
				<div class="bottom">
					...
					<!-- Social Icons -->
						<ul class="icons">
							<li><a href="https://fb.com/profile.php?id=100005228714420" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
							<li><a href="https://github.com/Kur0N3k0" class="icon fa-github"><span class="label">Github</span></a></li>
							<li><a href="mailto:newez2dj7@naver.com" class="icon fa-envelope"><span class="label">Email</span></a></li>
						</ul>
